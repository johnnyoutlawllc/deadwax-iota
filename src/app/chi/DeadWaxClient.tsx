...
export default function DeadWaxClient({
  ...
  return (
    <div className={`min-h-screen bg-background text-text-primary${isDark ? '' : ' theme-light'}`}>
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-background border-b border-border backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full border border-border bg-surface hover:bg-surface-hover transition-colors text-text-muted hover:text-accent"
